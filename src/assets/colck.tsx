  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black px-2">
      <div className="container mx-auto flex flex-col items-center px-2">
        <h1 className="text-3xl sm:text-4xl font-extrabold mb-6 text-cyan-400 tracking-widest drop-shadow-[0_0_10px_cyan]">
          Clocky
        </h1>
        <div className="bg-gray-900 px-4 sm:px-6 md:px-10 py-4 rounded-3xl shadow-[0_0_40px_#00ffffaa] max-w-full overflow-x-auto">
          <p className="text-4xl sm:text-5xl md:text-7xl font-mono text-cyan-400 tracking-widest drop-shadow-[0_0_15px_cyan] select-none whitespace-nowrap">
            {formatTime(time)}
          </p>
        </div>
      </div>
